...
imagePath = '/home/min/a/ee570/hw2-files/hw2-dataset/n04037443/n04037443_17929.JPEG'
nnInputHeight = 32
nnInputWidth  = 32
...
print("\tPut the following files into a folder called 'hw2':")
print("\t\t'hw2-train.prototxt'")
print("\t\t'hw2-solver.prototxt'")
print("\t\t'hw2-deploy.prototxt'")
print("\t\t'hw2-weights.caffemodel'")
print("\t\t'hw2.py'")
print("\tZIP the 'hw2' folder.  (No tarballs, please.)")
